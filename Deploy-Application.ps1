...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        ## Uninstall all Tableau Reader versions
		...
		$exitCode = Execute-Process -Path "$dirFiles\TableauReader-64bit-2020-1-0.exe" -Parameters "ACCEPTEULA=1 AUTOUPDATE=0 DATABASEDRIVERS=1 DESKTOPSHORTCUT=0 /quiet /norestart" -WindowStyle "Hidden" -PassThru
